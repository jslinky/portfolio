...
<p>I was responsible for every aspect of this project's design and development. Using Figma, I designed a modern, engaging, and user-friendly layout that accurately reflects my freelance agency’s brand identity. I then built the website using Tailwind CSS for streamlined styling and Alpine.js for lightweight JavaScript interactivity. GSAP was integrated to enhance the site's visual experience with smooth, engaging animations, creating a professional, dynamic online presence for my agency.</p>
    ...
    },    
    {
      ...
      description: `
            <h3>Overview</h3>
            <p>Brand / Website design and development for Fortitude Fitness International, a premier fitness and wellness provider.</p>
            <details open>
            <summary>My Role</summary>
            <p>A freelance project, I was tasked with designing and developing a website for Fortitude Fitness International, a fitness and wellness company that offers a range of programs and services to help clients achieve their fitness goals. The project involved creating a visually appealing and user-friendly website that effectively communicated the brand's values and offerings.</p>
            <p>Design</p>

<p>Using Figma, I crafted a unique and cohesive visual identity for Fortitude Fitness, which included designing the brand's logo and establishing a consistent color palette and typography that conveyed strength and sophistication. The website design was meticulously planned to reflect the brand's ethos, focusing on user experience and intuitive navigation. Key elements like high-quality imagery, motivational messaging, and a clean, modern aesthetic were integrated to inspire and engage visitors.</p>

<p>Development</p>

<p>The website was developed using Nuxt.js and CSS scroll timeline animations were employed adding an interactive element that showcases the progression of Fortitude Fitness's programs and services. These animations enhance the storytelling aspect of the site, guiding users through the brand's offerings and encouraging engagement.

Overall, this project exemplifies a balanced blend of design and development, resulting in a polished, professional digital platform that effectively communicates the Fortitude Fitness brand and its dedication to client transformation.</p>
            </details>
            `,
      images: [
        { url: "/img/fortitude-1.webp", alt: "Fortitude Fitness website screen 1" },
        { url: "/img/fortitude-2.webp", alt: "Fortitude Fitness website screen 2" },
        { url: "/img/fortitude-3.webp", alt: "Fortitude Fitness website screen 3" }
        ],
      tags: [
        "design",
        "nuxt",
      ...
      url: ["http://www.fortitudefitnessinternational.com"],
    },
    {
    ...
    },
    {
      ...
      images: [
        {
          url: "/img/starfield-dashboard.jpg",
          alt: "Lucozade Starfield Competition Dashboard",
        },
    ...
    },
    {
      ...
      description: `
            ...
            `,
      images: [{ url: "/img/ribena-home.png", alt: "" }],
    ...
    },
    {
      ...
      images: [
        {
          url: "/img/entry-system.png",
          alt: "Holograph Entry System Prototype",
        },
      ],
